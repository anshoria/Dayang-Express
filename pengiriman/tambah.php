        ...
        <div class="container" style="margin-top: 30px; margin-bottom: 30px;">
            <div class="card shadow">
                <div class="card-header">
                    <h2 class="mt-2">Tambah Pengiriman dan Barang</h2>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama" placeholder="Masukkan Nama Pelanggan" name="nama_pelanggan" required>
                    </div>
                    <div class="mb-3">
                        <label for="alamat" class="form-label">Alamat Pelanggan</label>
                        <input type="text" class="form-control" id="alamat" placeholder="Masukkan alamat pelanggan" name="alamat">
                    </div>
                    <div class="mb-3">
                        <label for="nohp" class="form-label">Nomor HP</label>
                        <input type="number" class="form-control" id="nohp" placeholder="Masukkan Nomor HP" name="nohp" maxlength="13">
                    </div>
                    <div class="mb-3">
                        <label for="namabr" class="form-label">Resi</label>
                        <input type="text" class="form-control" id="namabr" placeholder="Masukkan Resi Barang" name="resi" required>
                    </div>
                    <div class="mb-3">
                        <label for="berat" class="form-label">Berat Barang (kg)</label>
                        <input type="number" step="0.01" class="form-control" id="berat" placeholder="Masukkan Berat Barang" name="berat_barang" required>
                    </div>
                    <div class="mb-3">
                        <label for="harga" class="form-label">Harga Pengiriman (Rp)</label>
                        <input type="number" class="form-control" id="harga" placeholder="Masukkan Harga Pengiriman" name="harga" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control mt-2" id="cod" placeholder="Masukkan Pembayaran COD" name="cod">
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control mt-2" id="pincod" placeholder="Masukkan PIN COD" name="pincod">
                    </div>
                    <div class="mb-3">
