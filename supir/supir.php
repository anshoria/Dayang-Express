                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <div>
                            ...
                            <a class="nav-link text-light" href="../supir/supir.php">
                                <div class="sb-nav-link-icon text-light"><i class="fas fa-car" style="margin-right: 6px;"></i></div>
                                Data Supir
                            </a>
                            <hr class="sidebar-divider my-0">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <!-- Modal -->
                    <a href="tambah.php" class="btn btn-primary btn-sm mb-3 mt-4"><i class="fas fa-plus"></i> Tambahkan</a>
                    <div class="card shadow mb-4">
                        <div class="card-header">

                        </div>
                        <div class="card-body">
                            <h4 class="text-center"><i class="fas fa-car"></i> Data Supir</h4>
                            <table class="table table-striped" id="datatablesSimple">
                                ...
                                <tbody>
                                    <?php
                                    $supir = query("SELECT * FROM supir ORDER BY id DESC");
                                    $no = 1;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="../img/<?php echo $row['foto']; ?>">
                                                    <img src="../img/<?php echo $row['foto']; ?>" width="150" />
                                                </a>
                                            </td>
                                            <td>
                                                <div class="aksi">
