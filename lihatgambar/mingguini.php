...
<style>
    ...
    .card-body {
        ...
        /* Menengahkan gambar-gambar dalam card-body */
    }
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <p class="mt-5"><a href="gambar.php" class="btn btn-sm btn-primary">kembali</a> <a href="../home.php" class="btn btn-sm btn-success">Home</a></p>                  
                    <div class="pelanggan card shadow mt-3">
                        <div class="card-header">
                            <p style="margin: 0px;">gambar Minggu ini</p>
                        </div>
                        <div class="card-body">
                            <div class="image-container">
                                ...
                                $beginningOfWeek = date('Y-m-d', strtotime("-$diff days", $now));
                                $endOfWeek = date('Y-m-d', strtotime("+6 days", strtotime($beginningOfWeek)));

                                // Mengambil data gambar berdasarkan minggu ini
                                $query = "SELECT * FROM pengiriman WHERE tanggal >= '$beginningOfWeek' AND tanggal <= '$endOfWeek'";
                                $koneksi = koneksi();
                                $result = mysqli_query($koneksi, $query);

                                // Menampilkan gambar-gambar
                                while ($row = mysqli_fetch_assoc($result)) { ?>
                                    <img src="../img/<?php echo $row['foto'] ?>" alt="Gambar">
                                <?php }
                                ?>
                            </div>
