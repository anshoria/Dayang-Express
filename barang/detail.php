            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <?php foreach ($pengiriman as $row) : ?>
                        <div>
                            <p><a href="../home.php">Barang</a> / Detail Barang/ <?php echo $row["resi"] ?></p>
                            <div class="card shadow">
                                <div class="card-header">
                                    <p class="fw-bold" style="margin: 0px">Informasi Barang</p>
                                </div>
                                <div class="card-body">
                                    ...
                                    <br>
                                    <a href="../home.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm text-white mt-4">Kembali</a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
