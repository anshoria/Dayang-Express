        ...
        <div class="container" style="margin-top: 30px; margin-bottom: 30px;">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <input value="<?php echo $p["nama_pelanggan"]; ?>" type="hidden" class="form-control" id="nama" name="nama_pelanggan" required autocomplete="off">
                    </div>
                    <div class="mb-3">
                        <input value="<?php echo $p["alamat"]; ?>" type="hidden" class="form-control" id="alamat" name="alamat" required>
                    </div>
                    <div class="mb-3">
                        <input value="<?php echo $p["nohp"]; ?>" type="hidden" class="form-control" id="nohp" name="nohp" required maxlength="13">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <input value="<?php echo $p["harga"]; ?>" type="hidden" class="form-control" id="harga" name="harga" required>
                    </div>
